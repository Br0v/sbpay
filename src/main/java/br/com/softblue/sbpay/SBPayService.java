...
public class SBPayService {
	...
	public ResponseEntity<PaymentResponse> pagar(@RequestHeader("Token") String token,
			@Valid @RequestBody DadosCartao dadosCartao, Errors errors){		//request header extrai a info do header, body do corpo e valid é pra fazer validacao feita na classe do cartao
